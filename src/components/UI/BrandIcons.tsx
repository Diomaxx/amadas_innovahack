...
/**
 * Brand glyphs (single-path, 24x24) — lucide-react v1 dropped brand icons,
 * so these are inlined from the Simple Icons set.
 */
...
/** Logo oficial de Google (multicolor). No hereda currentColor. */
