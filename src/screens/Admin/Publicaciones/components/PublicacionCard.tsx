    ...
    <DialogPrimitive.Root>
      <article className="flex flex-col overflow-hidden rounded-xl border border-cv-cream-300 bg-white">
        ...
        <div className="flex flex-1 flex-col p-4">
          ...
          {/* Title */}
          <h3 className="mt-2 line-clamp-2 text-sm font-bold leading-snug text-cv-gray-900">
            {pub.titulo}
          </h3>

          {/* Description */}
          <p className="mt-1.5 line-clamp-3 text-xs leading-relaxed text-cv-gray-500">
            {pub.descripcion}
          </p>
          ...
          <div className="mt-3 space-y-1.5 text-xs text-cv-gray-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              />
              <span style={{ color: v.countColor }}>
                {formatFecha(pub.fecha)}
              </span>
            </div>
          </div>
