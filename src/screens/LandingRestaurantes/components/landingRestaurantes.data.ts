...
export const testimonial = {
  quote:
    "ALMA ha cambiado la forma en que entendemos nuestra despensa. No es solo comprar un producto, es ser parte de la regeneración de los bosques de Bolivia a través del plato.",
