...
export const steps = [
  ...
  },
  {
    ...
    description: "Acceso directo. Cierra tratos con chefs y restaurantes que valoran origen y calidad.",
  },
];
...
export const testimonials = [
  {
    quote:
      "RESPIRALARA cambió las reglas del juego. Ahora nos contactan con meses de anticipación.",
