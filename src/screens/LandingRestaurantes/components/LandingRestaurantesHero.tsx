    ...
    >
      ...
      >
        <motion.div
          ...
          className="flex h-10 w-6 items-start justify-center rounded-full border border-cv-green-700/40 p-1.5"
        >
          <span className="h-2 w-1 rounded-full bg-cv-green-700/70" />
        </motion.div>
      </motion.div>
    </section>
  );
